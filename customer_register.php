  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">ARE YOU NEW</span> AT LIKHA?
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<input type="text" class="form-control" placeholder="Enter Email Address" name="c_email" required>
...
<input type="password" class="form-control" id="pass" placeholder="Enter Password" name="c_pass" required>
...
<input type="password" class="form-control confirm" id="con_pass" placeholder="Enter Password" required>
...
<input type="text" class="form-control" name="c_contact" placeholder="Enter Contact No." required>
...
echo "<script>alert('This email is already registered, please try another one. Thank you!')</script>";
...
$insert_customer = "insert into customers (customer_name,customer_email,customer_pass,customer_contact,customer_address,customer_ip,customer_confirm_code) values ('$c_name','$c_email','$c_pass','$c_contact','$c_address','$c_ip','$customer_confirm_code')";
